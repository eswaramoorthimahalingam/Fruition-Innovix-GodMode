...
export function EnquiryForm() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setSubmitting(true);
    const text = `Hi Fruition Innovix,\n\nName: ${name}\nPhone: ${phone}\nEmail: ${email}\n\n${message}`;
    const url = `https://wa.me/919629126119?text=${encodeURIComponent(text)}`;
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <label className="block sm:col-span-2">
          ...
          <textarea
            ...
            maxLength={1000}
            rows={5}
            placeholder="Tell us about your project — web app, mobile app, branding, digital marketing, ERP/CRM..."
